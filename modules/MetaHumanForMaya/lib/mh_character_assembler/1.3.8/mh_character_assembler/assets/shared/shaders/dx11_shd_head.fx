...
float4 f(SHADERDATA IN, bool FrontFace : SV_IsFrontFace) : SV_Target {
	...
	if (UseNormalTexture) {
		...
		if (UseBlendTexture) {
			...
			float maskChannelVal_00 = maskChannel_00.Sample(SamplerAnisoWrap, blendUV).r;
			float maskChannelVal_01 = maskChannel_01.Sample(SamplerAnisoWrap, blendUV).g;
			float maskChannelVal_02 = maskChannel_02.Sample(SamplerAnisoWrap, blendUV).b;
			float maskChannelVal_03 = maskChannel_03.Sample(SamplerAnisoWrap, blendUV).a;
			float maskChannelVal_04 = maskChannel_04.Sample(SamplerAnisoWrap, blendUV).r;
			float maskChannelVal_05 = maskChannel_05.Sample(SamplerAnisoWrap, blendUV).g;
			float maskChannelVal_06 = maskChannel_06.Sample(SamplerAnisoWrap, blendUV).b;
			float maskChannelVal_07 = maskChannel_07.Sample(SamplerAnisoWrap, blendUV).a;
			float maskChannelVal_08 = maskChannel_08.Sample(SamplerAnisoWrap, blendUV).r;
			float maskChannelVal_09 = maskChannel_09.Sample(SamplerAnisoWrap, blendUV).g;
			float maskChannelVal_10 = maskChannel_10.Sample(SamplerAnisoWrap, blendUV).b;
			float maskChannelVal_11 = maskChannel_11.Sample(SamplerAnisoWrap, blendUV).a;
			float maskChannelVal_12 = maskChannel_12.Sample(SamplerAnisoWrap, blendUV).r;
			float maskChannelVal_13 = maskChannel_13.Sample(SamplerAnisoWrap, blendUV).g;
			float maskChannelVal_14 = maskChannel_14.Sample(SamplerAnisoWrap, blendUV).b;
			float maskChannelVal_15 = maskChannel_15.Sample(SamplerAnisoWrap, blendUV).r;
			float maskChannelVal_16 = maskChannel_16.Sample(SamplerAnisoWrap, blendUV).g;
			float maskChannelVal_17 = maskChannel_17.Sample(SamplerAnisoWrap, blendUV).b;
			float maskChannelVal_18 = maskChannel_18.Sample(SamplerAnisoWrap, blendUV).a;
			float maskChannelVal_19 = maskChannel_19.Sample(SamplerAnisoWrap, blendUV).r;
			float maskChannelVal_20 = maskChannel_20.Sample(SamplerAnisoWrap, blendUV).g;
			float maskChannelVal_21 = maskChannel_21.Sample(SamplerAnisoWrap, blendUV).b;
			float maskChannelVal_22 = maskChannel_22.Sample(SamplerAnisoWrap, blendUV).a;
			float maskChannelVal_23 = maskChannel_23.Sample(SamplerAnisoWrap, blendUV).r;
			float maskChannelVal_24 = maskChannel_24.Sample(SamplerAnisoWrap, blendUV).g;
			float maskChannelVal_25 = maskChannel_25.Sample(SamplerAnisoWrap, blendUV).r;
			float maskChannelVal_26 = maskChannel_26.Sample(SamplerAnisoWrap, blendUV).g;
			float maskChannelVal_27 = maskChannel_27.Sample(SamplerAnisoWrap, blendUV).b;
			float maskChannelVal_28 = maskChannel_28.Sample(SamplerAnisoWrap, blendUV).a;
			float maskChannelVal_29 = maskChannel_29.Sample(SamplerAnisoWrap, blendUV).r;
			float maskChannelVal_30 = maskChannel_30.Sample(SamplerAnisoWrap, blendUV).g;
			float maskChannelVal_31 = maskChannel_31.Sample(SamplerAnisoWrap, blendUV).b;
			float maskChannelVal_32 = maskChannel_32.Sample(SamplerAnisoWrap, blendUV).a;
			float maskChannelVal_33 = maskChannel_33.Sample(SamplerAnisoWrap, blendUV).r;
			float maskChannelVal_34 = maskChannel_34.Sample(SamplerAnisoWrap, blendUV).g;
			float maskChannelVal_35 = maskChannel_35.Sample(SamplerAnisoWrap, blendUV).b;
			float maskChannelVal_36 = maskChannel_36.Sample(SamplerAnisoWrap, blendUV).a;
