...
class CategoryWidget(QtWidgets.QWidget):
    def __init__(self, name):
        ...
        self._category_button.setIcon(QtGui.QIcon(QtGui.QPixmap("PoseEditor:frame_open.png")))
    ...
    def _toggle_category_visibility(self):
        ...
        self._category_button.setIcon(
            QtGui.QIcon(QtGui.QPixmap("PoseEditor:frame_open.png"))
            if self._category_button.isChecked()
            else QtGui.QIcon(QtGui.QPixmap("PoseEditor:frame_closed.png"))
        )
